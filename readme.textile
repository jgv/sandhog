...
p. You can query Sandhog for every subway and major bridge/tunnel for now. All the buses are yet to be added. Right now only a few are covered. Check out @example.php@.